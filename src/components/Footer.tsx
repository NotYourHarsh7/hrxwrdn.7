        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-4">
              {[
                { Icon: GithubIcon, href: 'https://github.com/NotYourHarsh7' },
                { Icon: LinkedinIcon, href: 'https://www.linkedin.com/in/harshwardhanahlawat/' },
                { Icon: InstagramIcon, href: 'https://www.instagram.com/notyourharsh_.7?igsh=ODA0aDFxdXMzaTEy' },
              ].map(({ Icon, href }, i) => (
                <motion.a
                  key={i}
                  href={href}
