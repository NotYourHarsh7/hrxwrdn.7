...
const socials = [
  { icon: GithubIcon, label: 'GitHub', href: '#', handle: '@alexchen' },
  { icon: LinkedinIcon, label: 'LinkedIn', href: '#', handle: '/in/alexchen' },
  { icon: TwitterIcon, label: 'Twitter / X', href: '#', handle: '@alexchen_dev' },
];
